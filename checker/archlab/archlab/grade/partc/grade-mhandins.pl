...
# called <handin>.grades/<prefix>.out. The <prefix> is typically of the
# form <studentid>-<version>, e.g., "bovik-1"
#
#  Usage: unix> ./grade-handins
# 
# Bugs:
...
# student has a unique <prefix>, typically of the form <studentid>-<version>
