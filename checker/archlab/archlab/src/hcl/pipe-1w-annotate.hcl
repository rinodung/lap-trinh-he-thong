...
#/* $begin pipe-f_predPC-hcl */
word f_predPC = [
	f_icode in { IJXX, ICALL } : f_valC;
	## 1W: Want to refetch popq one time
	1 : f_valP;
];
#/* $end pipe-f_predPC-hcl */
#/* $end pipe-fetch-logic-hcl */
#/* $end pipe-fetch-all-hcl */
...
#/* $begin pipe-nobypass-hcl */
#/* $begin pipe-d_valA-hcl */
word d_valA = [
...
# At most one of these can be true.
#/* $begin pipe-D-stall-hcl */
bool D_stall = 
	# Conditions for a load/use hazard
	E_icode in { IMRMOVQ, IPOPQ } &&
	 E_dstM in { d_srcA, d_srcB };
#/* $end pipe-D-stall-hcl */

#/* $begin pipe-D-bubble-hcl */
bool D_bubble =
	# Mispredicted branch
	(E_icode == IJXX && !e_Cnd) ||
	# Stalling at fetch while ret passes through pipeline
	...
	# 1W: This condition will change
	  IRET in { D_icode, E_icode, M_icode };
#/* $end pipe-D-bubble-hcl */

# Should I stall or inject a bubble into Pipeline Register E?
# At most one of these can be true.
bool E_stall = 0;
#/* $begin pipe-E-bubble-hcl */
bool E_bubble =
	# Mispredicted branch
	(E_icode == IJXX && !e_Cnd) ||
	# Conditions for a load/use hazard
	E_icode in { IMRMOVQ, IPOPQ } &&
	 E_dstM in { d_srcA, d_srcB};
#/* $end pipe-E-bubble-hcl */

# Should I stall or inject a bubble into Pipeline Register M?
# At most one of these can be true.
bool M_stall = 0;
#/* $begin pipe-M-bubble-hcl */
# Start injecting bubbles as soon as exception passes through memory stage
bool M_bubble = m_stat in { SADR, SINS, SHLT } || W_stat in { SADR, SINS, SHLT };
#/* $end pipe-M-bubble-hcl */

# Should I stall or inject a bubble into Pipeline Register W?
#/* $begin pipe-W-stall-hcl */
bool W_stall = W_stat in { SADR, SINS, SHLT };
#/* $end pipe-W-stall-hcl */
bool W_bubble = 0;
#/* $end pipe--hcl */
#/* $end pipe-all-hcl */
